...
public class Main : Gtk.Window
{
    ...
    //Get GTK ready to rock and roll
  	...
  	//Setup Our Window Properties
		...
		window.icon = new Pixbuf.from_resource("/org/gnome/Vibbles/vibbles.png");
		window.add(board);
		window.show_all ();
		Gtk.main ();
		return 0;
...
public class Board : DrawingArea
{
	...
	public Board()
	{
		...
		Dot = new Pixbuf.from_resource("/org/gnome/Vibbles/dot.png");
		Head = new Pixbuf.from_resource("/org/gnome/Vibbles/head.png");
		Apple = new Pixbuf.from_resource("/org/gnome/Vibbles/apple.png");
